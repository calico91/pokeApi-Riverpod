...
InfoPokemon infoPokemonFromJson(String str) => InfoPokemon.fromJson(json.decode(str));

String infoPokemonToJson(InfoPokemon data) => json.encode(data.toJson());
...
class InfoPokemon {
    ...
    factory InfoPokemon.fromJson(Map<String, dynamic> json) => InfoPokemon(
